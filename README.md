...
## 미비사항 or 막힌 부분
- 로그인 로그아웃 구현 부분에 대한 구현을 자료를 보지않고 혼자서는 아직 어렵습니다.
- 전체적인 구조파악과 어노테이션별 용도를 복습해야 할것 같습니다.

## UI/UX (화면 캡처본을 복사 붙여 넣기, url 주소 나오도록)

- **게시글 리스트 페이지** (URL: `http://localhost:8080/article/list` 또는 `http://localhost:8080/`)
  - ![리스트 페이지](./img/list.PNG)

- **게시글 등록 폼 페이지** (URL: `http://localhost:8080/article/create`)
  - ![등록 폼 페이지](./img/create.PNG)

- **게시글 상세 페이지** (URL: `http://localhost:8080/article/detail/{id}`)
  - ![상세 페이지](./img/detail.PNG)

- **로그인 페이지** (URL: `http://localhost:8080/members/login`)
  - ![로그인 페이지](./img/login.PNG)

- **회원가입 페이지** (URL: `http://localhost:8080/members/signup`)
  - ![회원가입 페이지](./img/signup.PNG)
